object frmRelComissaoBKP: TfrmRelComissaoBKP
  Left = -1
  Top = 114
  Width = 737
  Height = 375
  Caption = 'Relatório de Comissão BKP'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object qrpRelComissaoBKP: TQuickRep
    Left = 6
    Top = 10
    Width = 794
    Height = 1123
    ...
    object qrbTotais: TQRBand
      ...
      object qrlTCliJales: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Total de Clientes da Jales :'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
