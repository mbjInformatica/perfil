...
type
  TformSituacaoRamAtv = class(TForm)
...
var
  formSituacaoRamAtv: TformSituacaoRamAtv;
...
procedure TformSituacaoRamAtv.btnOKClick(Sender: TObject);
begin
...
procedure TformSituacaoRamAtv.FormShow(Sender: TObject);
begin
