...
dmBaseDados.tblANotaFiscalValorVista.AsFloat      := fltTotal - strDescNFe + strFrete;
...
//***-------------------------------------------------------------------------------------------------------------------------------------------------***
  //Geração do arquivo para Nota Fiscal Eletrônica...:
    ...
    Rewrite(ArquivoNFe);
      ...
      Writeln(ArquivoNFe, 'C|AUTO PECAS E ACESSORIOS PERFIL LTDA - ME||492200974112||||'  +CRT+'|');
      Writeln(ArquivoNFe, 'C02|61429791000164|');
      Writeln(ArquivoNFe, 'C05|AVENIDA ANALICE SAKATAUSKAS|580||V N OSASCO|3534401|OSASCO|SP|06060003|1058|BRASIL||');
