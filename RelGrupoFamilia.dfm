object formRelGrupoFamilia: TformRelGrupoFamilia
  Left = -4
  Top = -4
  Width = 1288
  Height = 778
  Caption = 'Relat'#243'rio de Categorias de Produtos Agrupado por Fam'#237'lia'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object rptGrupoFamilia: TQuickRep
    Left = 8
    Top = 8
    Width = 794
    Height = 1123
    ...
    object bndCabecalho: TQRBand
      ...
      object lblTitulo: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'RELAT'#211'RIO DE CATEGORIAS AGRUPADO POR FAM'#205'LIAS'
        Color = clWhite
        Transparent = False
        WordWrap = True
        FontSize = 10
    ...
    object bndCategorias: TQRSubDetail
      Left = 38
      Top = 118
      Width = 718
      Height = 40
      ...
      Size.Values = (
        105.833333333333300000
        1899.708333333333000000)
      Master = rptGrupoFamilia
      DataSet = dmBaseDados.tblCategoria
      PrintBefore = False
      PrintIfEmpty = True
      ...
      object fldDescricaoCategoria: TQRDBText
        Left = 232
        Top = 8
        Width = 114
        Height = 17
