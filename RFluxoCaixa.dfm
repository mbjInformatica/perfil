object formRelFluxoCaixa: TformRelFluxoCaixa
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object qrpFluxoCaixa: TQuickRep
    Left = 21
    Top = 8
    Width = 794
    Height = 1123
    ...
    DataSet = dmBaseDados.tblFluxoCaixa
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'Arial'
    ...
    object bndSumario: TQRBand
      ...
      object exprValorTotal: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(tblFluxoCaixa.ValorLancamento)'
        Mask = 'R$ ###,##0.00'
        FontSize = 10
      end
      object qrePagar: TQRExpr
        Left = 453
        Top = 24
        Width = 201
        Height = 17
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(tblFluxoCaixa.TotalPagar)'
        Mask = 'R$ ###,##0.00'
        FontSize = 10
      end
      object qreReceber: TQRExpr
        Left = 439
        Top = 4
        Width = 216
        Height = 17
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(tblFluxoCaixa.TotalReceber)'
        Mask = 'R$ ###,##0.00'
        FontSize = 10
      end
