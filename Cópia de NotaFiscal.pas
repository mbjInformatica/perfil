...
uses Windows, Messages, SysUtils, Classes, Graphics, Controls,
     ...
     SHDocVw, pcnNFeW, IniFiles, ShellAPI, pcnRetConsReciNFe,
     MidasLib, Math, TILabel, TISLABELS,
  ...
  //Geração do arquivo para Nota Fiscal Eletrônica...:
    ...
    with (ACBrNFe1.NotasFiscais.Add.NFe) do
      ...
      if (dmBaseDados.tblANotaFiscalValorICMS.AsFloat > 0) then
       ...
       begin
        Writeln(ArquivoNFe, 'Z|' +'|' +edtObsComp.Text+ ' / De acordo com a Portaria Cat 162/2008 artigo 18 Inciso I Alinea b, e permitido o cancelamento de NF-e somente em ate 24 horas apos sua emissao. / ' +'NFe emitida por ME, optante pelo Simples Nacional. Nao gera direito a credito de IPI. '  + strMsgTrib +'|');
