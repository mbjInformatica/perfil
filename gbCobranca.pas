...
begin
   ...
   begin
      ...
      txtEspecieDocumento.Caption     := 'DM'; //AEspecieDocumento;
      ...
      case Sacado.TipoInscricao of
        ...
        // tiPessoaJuridica: txtSacadoCPFCGC.Caption := 'CNPJ: ' + FormatarComMascara('!00\.000\.000\/0000\-00;0; ',Sacado.NumeroCPFCGC);
         tiPessoaFisica   : txtSacadoCPFCGC.Caption := 'CPF:  ' + Sacado.NumeroCPFCGC ;
         tiPessoaJuridica : txtSacadoCPFCGC.Caption := 'CNPJ: ' + Sacado.NumeroCPFCGC;
      ...
      txtEspecieDocumento2.Caption     := 'DM'; //AEspecieDocumento;
      if AceiteDocumento = adSim then
       ...
       case Sacado.TipoInscricao of
         ...
         tiPessoaFisica   : txtSacadoCPFCGC2.Caption := 'CPF:  ' + Sacado.NumeroCPFCGC ;
         tiPessoaJuridica : txtSacadoCPFCGC2.Caption := 'CNPJ: ' + Sacado.NumeroCPFCGC;
       ...
       txtEspecieDocumento3.Caption     := 'DM'; //AEspecieDocumento;
      if AceiteDocumento = adSim then
       ...
       case Sacado.TipoInscricao of
         ...
         tiPessoaFisica   : txtSacadoCPFCGC3.Caption := 'CPF:  ' + Sacado.NumeroCPFCGC ;
         tiPessoaJuridica : txtSacadoCPFCGC3.Caption := 'CNPJ: ' + Sacado.NumeroCPFCGC;
