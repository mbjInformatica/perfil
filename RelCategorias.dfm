object formRelCategoria: TformRelCategoria
  Left = 192
  Top = 107
  Width = 544
  Height = 375
  Caption = 'Relat'#243'rio de Categorias de Produtos'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object rptCategorias: TQuickRep
    Left = 8
    Top = 8
    Width = 794
    Height = 1123
    ...
    object bndCabecalho: TQRBand
      ...
      object lblTitulo: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'RELAT'#211'RIO DE CATEGORIAS DE PRODUTOS'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
    ...
    object bndColunas: TQRBand
      ...
      object lblCodigoCategoria: TQRLabel
        Left = 32
        Top = 8
        Width = 118
        Height = 17
      ...
      object lblDescricaoCategoria: TQRLabel
        Left = 176
        Top = 8
        Width = 136
        Height = 17
